...
export default function ModuleLauncher(){
 ...
 return <>
  ...
  <style jsx global>{`
   :root{--khn-sidebar:270px;--khn-topbar:70px;--khn-green:#173f35;--khn-green-dark:#102f28;--khn-yellow:#f5c400}
